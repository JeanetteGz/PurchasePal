    ...
    const emailResponse = await resend.emails.send({
      ...
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f8fafc;">
          <!-- Header -->
          <div style="background: linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%); padding: 40px 30px; text-align: center; border-radius: 16px 16px 0 0;">
          ...
          <div style="background: #ffffff; padding: 40px 30px; border-radius: 0 0 16px 16px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08);">
            ...
            <div style="text-align: center; margin-bottom: 32px;">
              ...
              <p style="font-size: 16px; color: #6b7280; margin: 0; line-height: 1.6;">We received a request to reset your password. Click the button below to create a new password.</p>
            </div>
            ...
            <!-- Security Info -->
            <div style="background: #f0f9ff; border-radius: 12px; padding: 24px; margin: 32px 0; border: 1px solid #bae6fd;">
              <h3 style="font-size: 18px; font-weight: 600; color: #0369a1; margin: 0 0 16px 0; text-align: center;">Security reminder 🛡️</h3>
              <div style="display: grid; gap: 12px;">
                <div style="display: flex; align-items: center; color: #075985;">
                ...
                <div style="display: flex; align-items: center; color: #075985;">
                  <span style="margin-right: 12px; font-size: 20px;">❓</span>
                  <span style="font-size: 15px;">Didn't request this? You can safely ignore this email</span>
                </div>
              </div>
            </div>
