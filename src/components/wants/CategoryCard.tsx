...
export const CategoryCard = ({ category, items, categoryEmoji, onClick }: CategoryCardProps) => {
  ...
  return (
    <Card 
      className="group cursor-pointer bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] overflow-hidden rounded-2xl relative h-full"
      onClick={onClick}
    >
      ...
      <CardContent className="relative p-5 h-full flex flex-col">
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-gray-800 dark:text-gray-200 capitalize group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                {category}
              </h3>
        ...
        <div className="flex -space-x-1 overflow-hidden mb-4">
          ...
          {items.length > 3 && (
            <div className="relative inline-block h-10 w-10 rounded-lg ring-2 ring-white dark:ring-gray-800 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 flex items-center justify-center text-xs font-bold text-blue-600 dark:text-blue-400 shadow-sm">
        ...
        {/* Latest item preview */}
        {items.length > 0 && (
          <div className="bg-gradient-to-r from-gray-50 to-blue-50/50 dark:from-gray-700/50 dark:to-blue-900/20 rounded-lg p-3 border border-gray-100 dark:border-gray-600 mt-3">
